 ...
 * @date 22 Apr 2018
 * @brief Ejercicio 2 práctica 3 con los cambios necesarios para que funcione correctamente.
 */
 ...
 * @param semid id del semaforo usado para controlar la sincronizacion de procesos
